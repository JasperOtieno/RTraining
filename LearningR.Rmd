...
#### For Loops by index
Loops over a vector of integer index values typically starting at 1, and these integers are used to access the values we need from one or more vectors at the position indicated by the index.
...
(mass_sapply <- sapply(volumes, est_mass)) # this code is simmilar to the above for loop
